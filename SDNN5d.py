...
def solve_Multiscale_PDE(R):
    ...
    region_lb = 0.0
    region_rt = 1.0
    u_true, f, A_eps = MS_LaplaceEqs.get_laplace_multi_scale_infos5D(
    ...
    if R['testData_model'] == 'random_generate':
        ...
        test_xyzst_bach = matData2Laplacian.get_data2Laplacian_explicit(dim=input_dim, data_path=mat_data_path)
        saveData.save_testData_or_solus2mat(test_xyzst_bach, dataName='testXYZST', outPath=R['FolderName'])
